-- Primero eliminar la función existente que usa username
DROP FUNCTION IF EXISTS public.authenticate_user(input_username text, input_password text);

-- Crear la función nueva que usa email
